...
export default function Hero() {
  ...
  return (
    <section className="relative overflow-hidden bg-gradient-to-tr from-slate-950 via-blue-950 to-indigo-950 text-white">
      {/* Dynamic Background elements */}
      <div className="absolute inset-0 -z-10">
        <div className="absolute top-[-10%] left-[-10%] w-[40%] h-[40%] bg-blue-600/20 blur-[120px] rounded-full animate-pulse"></div>
        <div className="absolute bottom-[-10%] right-[-10%] w-[40%] h-[40%] bg-indigo-600/20 blur-[120px] rounded-full animate-pulse [animation-delay:2s]"></div>
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-24 lg:py-40">
        <div className="mx-auto max-w-5xl text-center">
          {/* Badge */}
          <div className="inline-flex items-center rounded-full bg-white/10 backdrop-blur-md border border-white/20 px-4 py-1.5 text-sm font-medium text-blue-200 mb-8 animate-fade-in">
          ...
          <h1 className="text-5xl sm:text-6xl lg:text-8xl font-black tracking-tighter mb-8 leading-tight">
            E-Fatura <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-cyan-300">Geleceğini</span>
            <span className="block italic">Bugünden Yaşayın</span>
          </h1>

          {/* Subheading */}
          <p className="text-xl sm:text-2xl text-blue-100/70 mb-12 max-w-3xl mx-auto leading-relaxed">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-6 mb-20">
            <Link href="/register">
              <Button size="lg" className="w-full sm:w-auto text-lg px-10 py-7 bg-blue-600 hover:bg-blue-500 shadow-[0_0_30px_-5px_rgba(37,99,235,0.5)] transition-all duration-300 hover:scale-105 active:scale-95 group">
                Ücretsiz Deneyin
          ...
          <div className="flex flex-wrap justify-center gap-4 mb-20">
            {features.map((feature, index) => (
              <div
                key={index}
                className="group flex items-center gap-3 rounded-2xl border border-white/10 bg-white/5 backdrop-blur-sm px-6 py-3 text-base font-semibold hover:border-blue-400/50 hover:bg-blue-400/10 transition-all duration-300 cursor-default"
              >
                <span className="text-blue-400 group-hover:scale-110 transition-transform">{feature.icon}</span>
                <span className="text-blue-50/90">{feature.text}</span>
              </div>
            ))}
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 lg:gap-8 p-8 rounded-3xl border border-white/10 bg-white/5 backdrop-blur-xl">
            <div className="space-y-1">
              ...
              <div className="text-sm font-medium text-blue-200/60 uppercase tracking-widest">Aktif Kullanıcı</div>
            </div>
            <div className="space-y-1">
              ...
              <div className="text-sm font-medium text-blue-200/60 uppercase tracking-widest">İşlenen Fatura</div>
            </div>
            <div className="space-y-1">
        ...
        <div className="mt-24 relative max-w-6xl mx-auto">
          <div className="absolute -inset-4 bg-gradient-to-r from-blue-600 to-indigo-600 rounded-[2.5rem] blur-3xl opacity-20 animate-pulse"></div>
          <div className="relative bg-slate-900/80 border border-white/10 rounded-2xl shadow-2xl overflow-hidden backdrop-blur-xl group hover:border-blue-500/30 transition-all duration-700 hover:-translate-y-2">
            <div className="flex items-center gap-2 px-6 py-4 bg-white/5 border-b border-white/10">
              ...
              <div className="flex-1 text-center">
                <div className="text-xs font-mono text-white/30 lowercase tracking-widest">secure-dashboard.antigravity.com</div>
              </div>
            </div>
